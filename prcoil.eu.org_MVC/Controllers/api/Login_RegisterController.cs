...
using prcoil.eu.org_MVC.Models.Data;
...
public class LoginRegisterController : ControllerBase
{
    ...
    public IActionResult UserLogin([FromBody] UserLoginData? userLoginData)
    {
        if (userLoginData != null)
        {
            ...
            //如果找到账户:
            if (password == mySqlService.MySqlSelect("passworld", "cellphone", cellphone, _defultSelectTable))
            {
    ...
    public IActionResult UserRegisher([FromBody] UserRegisterData? userRegisterData)
    {
        if (userRegisterData != null)
        {
            ...
            if ("DataNotFound" == mySqlService.MySqlSelect("passworld", "cellphone", cellphone, _defultSelectTable))
            {
                mySqlService.MySqlInsertWebReg("username", "email", "cellphone", "passworld", _defultSelectTable,
            ...
            if (mySqlService.MySqlSelect("passworld", "cellphone", cellphone, _defultSelectTable) != "DataNotFound")
